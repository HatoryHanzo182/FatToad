...
<div class="marking">
    ...
    <div class="authorization-block">
        <form class="form">
            ...
            <p class="p">Don't have an account? <span id="id-sign-up" class="span">Sign Up</span></p>
    ...
    <div class="registration-block">
        <form class="form">
            ...
            <p class="p">Already in our ranks? <span id="id-sign-in" class="span">Sign In</span></p>
        </form>
    </div>
    <!-- Art. -->
    <div class="art-block">
