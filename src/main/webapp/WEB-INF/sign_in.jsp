    ...
    <div class="authorization-block">
        <form class="form">
            ...
            <div class="inputForm">
                ...
                <input id="id-email-signin" type="text" class="input" placeholder="Enter your Email">
            </div>
            <div class="error-message"><p id="id-error-email-message-signin"></p></div>
            <div class="flex-column"><label>Password</label></div>
            <div class="inputForm">
                <ion-icon name="finger-print-outline"></ion-icon>
                <input  id="id-password-signin" type="password" class="input" placeholder="Enter your Password">
            ...
            <div class="error-message"><p id="id-error-password-message-signin"></p></div>
            <div class="flex-row">
                <div>
                    <input type="checkbox">
            ...
            <button id="id-button-signin" class="button-submit">Sign In</button>
            <p class="p">Don't have an account?
                <span id="id-sign-up" class="span">
                    <%= "sign_up.jsp".equals(page_body) ? "" : ""%><a href="<%=context%>/signup">Sign Up</a>
                </span>
            </p>
...
<script src="<%=context%>/js/signin..js"></script>